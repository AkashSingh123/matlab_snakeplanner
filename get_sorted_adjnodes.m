function adj_nodes_retfinal=get_sorted_adjnodes(adj_nodes,target_point_buffer)
...
for i=1:size(adj_nodes_ret,1)
    if(round(adj_nodes_ret(i,1:2),2)==round(target_point_buffer( target_buf_len-1,1:2),2))
        rem=i;       
    end
end
if(rem==1)
